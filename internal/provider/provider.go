...
import (
	"context"
	"fmt"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/blob_store"
	...
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/content_selector"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/privilege"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/repository"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/role"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/system"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/task"
	"github.com/tinyorbitvn/terraform-provider-sonatyperepo/internal/provider/user"
	"net/http"
	"net/url"
	"os"
	"regexp"
