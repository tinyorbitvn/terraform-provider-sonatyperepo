...
// P2 Proxy
// ----------------------------------------
type RepositoryP2ProxyModel struct {
	RepositoryProxyModel
}

func (m *RepositoryP2ProxyModel) MapMissingApiFieldsFromPlan(planModel RepositoryP2ProxyModel) {
	m.HttpClient.MapMissingApiFieldsFromPlan(planModel.HttpClient)
}

func (m *RepositoryP2ProxyModel) FromApiModel(api sonatyperepo.SimpleApiProxyRepository) {
...
func (m *RepositoryP2ProxyModel) ToApiCreateModel() sonatyperepo.P2ProxyRepositoryApiRequest {
	apiModel := sonatyperepo.P2ProxyRepositoryApiRequest{
...
func (m *RepositoryP2ProxyModel) ToApiUpdateModel() sonatyperepo.P2ProxyRepositoryApiRequest {
