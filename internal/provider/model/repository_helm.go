...
// Helm Hosted
// ----------------------------------------
type RepositoryHelmHostedModel struct {
	RepositoryHostedModel
}

func (m *RepositoryHelmHostedModel) FromApiModel(api sonatyperepo.SimpleApiHostedRepository) {
	m.mapSimpleApiHostedRepository(api)
}

func (m *RepositoryHelmHostedModel) ToApiCreateModel() sonatyperepo.HelmHostedRepositoryApiRequest {
	apiModel := sonatyperepo.HelmHostedRepositoryApiRequest{
...
func (m *RepositoryHelmHostedModel) ToApiUpdateModel() sonatyperepo.HelmHostedRepositoryApiRequest {
...
func (m *RepositoryHelmProxyModel) ToApiCreateModel() sonatyperepo.HelmProxyRepositoryApiRequest {
	apiModel := sonatyperepo.HelmProxyRepositoryApiRequest{
		Name:    m.Name.ValueString(),
		Online:  m.Online.ValueBool(),
