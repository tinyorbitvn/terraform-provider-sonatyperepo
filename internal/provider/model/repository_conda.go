...
// Conda Proxy
// ----------------------------------------
type RepositoryCondaProxyModel struct {
...
func (m *RepositoryCondaProxyModel) ToApiCreateModel() sonatyperepo.CondaProxyRepositoryApiRequest {
	apiModel := sonatyperepo.CondaProxyRepositoryApiRequest{
...
func (m *RepositoryCondaProxyModel) ToApiUpdateModel() sonatyperepo.CondaProxyRepositoryApiRequest {
