...
// NewRepositorySwiftProxyResource is a helper function to simplify the provider implementation.
func NewRepositorySwiftProxyResource() resource.Resource {
	return &repositoryResource{
		RepositoryFormat: &format.SwiftRepositoryFormatProxy{},
