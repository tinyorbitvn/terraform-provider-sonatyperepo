...
// NewRepositoryGoProxyResource is a helper function to simplify the provider implementation.
func NewRepositoryGoProxyResource() resource.Resource {
	return &repositoryResource{
		RepositoryFormat: &format.GoRepositoryFormatProxy{},
		RepositoryType:   format.REPO_TYPE_PROXY,
	}
}

// NewRepositoryGoGroupResource is a helper function to simplify the provider implementation.
func NewRepositoryGoGroupResource() resource.Resource {
	return &repositoryResource{
		RepositoryFormat: &format.GoRepositoryFormatGroup{},
