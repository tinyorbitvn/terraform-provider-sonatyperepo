...
`, resourceTypeRubyGemsHosted, randomString, resourceTypeRubyGemsProxy, randomString, resourceTypeRubyGemsGroup, randomString, randomString, resourceTypeRubyGemsProxy),
				Check: resource.ComposeAggregateTestCheckFunc(
					// Verify Hosted
					resource.TestCheckResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_NAME, fmt.Sprintf("ruby-gems-hosted-repo-%s", randomString)),
					resource.TestCheckResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_ONLINE, "true"),
					resource.TestCheckResourceAttrSet(resourceRubyGemsHostedName, repotest.RES_ATTR_URL),
					resource.TestCheckResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_STORAGE_BLOB_STORE_NAME, common.DEFAULT_BLOB_STORE_NAME),
					resource.TestCheckResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_STORAGE_STRICT_CONTENT_TYPE_VALIDATION, "true"),
					resource.TestCheckResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_STORAGE_WRITE_POLICY, common.WRITE_POLICY_ALLOW_ONCE),
					resource.TestCheckResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_COMPONENT_PROPRIETARY_COMPONENTS, "false"),
					resource.TestCheckNoResourceAttr(resourceRubyGemsHostedName, repotest.RES_ATTR_CLEANUP),

					// Verify Proxy
					resource.TestCheckResourceAttr(resourceRubyGemsProxyName, repotest.RES_ATTR_NAME, fmt.Sprintf("ruby-gems-proxy-repo-%s", randomString)),
					resource.TestCheckResourceAttr(resourceRubyGemsProxyName, repotest.RES_ATTR_ONLINE, "true"),
					resource.TestCheckResourceAttrSet(resourceRubyGemsProxyName, repotest.RES_ATTR_URL),
					resource.TestCheckResourceAttr(resourceRubyGemsProxyName, repotest.RES_ATTR_STORAGE_BLOB_STORE_NAME, common.DEFAULT_BLOB_STORE_NAME),
					resource.TestCheckResourceAttr(resourceRubyGemsProxyName, repotest.RES_ATTR_STORAGE_STRICT_CONTENT_TYPE_VALIDATION, "true"),
					...
					// Verify Group
					resource.TestCheckResourceAttr(resourceRubyGemsGroupName, repotest.RES_ATTR_NAME, fmt.Sprintf("ruby-gems-group-repo-%s", randomString)),
					resource.TestCheckResourceAttr(resourceRubyGemsGroupName, repotest.RES_ATTR_ONLINE, "true"),
					resource.TestCheckResourceAttrSet(resourceRubyGemsGroupName, repotest.RES_ATTR_URL),
					resource.TestCheckResourceAttr(resourceRubyGemsGroupName, repotest.RES_ATTR_STORAGE_BLOB_STORE_NAME, common.DEFAULT_BLOB_STORE_NAME),
...
`, resourceTypeRubyGemsHosted, memberName, resourceTypeRubyGemsGroup, repoName, memberName, resourceTypeRubyGemsHosted),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr(resourceRubyGemsGroupName, repotest.RES_ATTR_NAME, repoName),
					resource.TestCheckResourceAttr(resourceRubyGemsGroupName, repotest.RES_ATTR_ONLINE, "true"),
				),
			},
